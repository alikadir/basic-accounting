...
// (DO NOT EDIT: machine generated header) 'SUIProgressBar.pas' rev: 6.00
...
private:
	...
	void __fastcall UpdateBar(int Length);
...
public:
	...
	/* TWinControl.CreateParented */ inline __fastcall TsuiProgressBar(HWND ParentWindow) : Extctrls::TCustomPanel(ParentWindow) { }
	#pragma option pop
