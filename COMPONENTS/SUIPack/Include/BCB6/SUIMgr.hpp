...
// (DO NOT EDIT: machine generated header) 'SUIMgr.pas' rev: 6.00
...
public:
	...
	void __fastcall GetBitmap(const int Index, const Graphics::TBitmap* Buf)/* overload */;
	void __fastcall GetBitmap(const int Index, const Graphics::TBitmap* Buf, int SpitCount, int SpitIndex)/* overload */;
