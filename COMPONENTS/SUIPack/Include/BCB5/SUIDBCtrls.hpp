...
// (DO NOT EDIT: machine generated header) 'SUIDBCtrls.pas' rev: 5.00
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TsuiDBEdit(HWND ParentWindow) : Dbctrls::TDBEdit(
		ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TsuiDBMemo(HWND ParentWindow) : Dbctrls::TDBMemo(
		ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TsuiDBImage(HWND ParentWindow) : Dbctrls::TDBImage(
		ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TsuiDBListBox(HWND ParentWindow) : Dbctrls::TDBListBox(
		ParentWindow) { }
	#pragma option pop
...
private:
	...
	HIDESBASE MESSAGE void __fastcall WMPAINT(Messages::TMessage &Msg);
	MESSAGE void __fastcall WMEARSEBKGND(Messages::TMessage &Msg);
	MESSAGE void __fastcall CBNCloseUp(Messages::TWMCommand &Msg);
