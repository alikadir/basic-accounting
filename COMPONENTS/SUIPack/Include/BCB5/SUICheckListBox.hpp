...
// (DO NOT EDIT: machine generated header) 'SUICheckListBox.pas' rev: 5.00
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TsuiCheckListBox(HWND ParentWindow) : Checklst::TCheckListBox(
		ParentWindow) { }
	#pragma option pop
