...
// (DO NOT EDIT: machine generated header) 'SUIThemes.pas' rev: 5.00
...
typedef AnsiString SUIThemes__1[42];
...
typedef TsuiType TsuiThemeItemType[42];

typedef TsuiThemeItem TsuiThemeDef[42];
...
static const Shortint SUI_THEME_ITEM_COUNT = 0x2a;
extern PACKAGE AnsiString SUI_FILETHEME_ITEMNAME[42];
extern PACKAGE TsuiType SUI_ITEM_TYPE[42];
extern PACKAGE TsuiUIStyle __fastcall GetSUIFormStyle(Classes::TComponent* Owner);
extern PACKAGE void __fastcall GetInsideThemeBitmap(TsuiUIStyle Theme, const int Index, const Graphics::TBitmap* 
	Buf, int SpitCount, int SpitIndex);
